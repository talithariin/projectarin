...
root.geometry("2560x1600+0+0") # menentukan ukuran window aplikasi
root.resizable(1,1)
...
buttonTotal= Button(buttonFrame,text='Total',font=('arial',12,'bold'),fg='black',bg='#b38b59',bd=3,padx=12,
                    command=totalcost)
buttonTotal.grid(row=0,column=0)

buttonStruk= Button(buttonFrame,text='Receipt',font=('arial',12,'bold'),fg='black',bg='#b38b59',bd=3,padx=12,
                    command=struk)
buttonStruk.grid(row=0,column=1)

buttonSimpan= Button(buttonFrame,text='Save',font=('arial',12,'bold'),fg='black',bg='#b38b59',bd=3,padx=12,
                    command=save)
buttonSimpan.grid(row=0,column=2)

buttonReset= Button(buttonFrame,text='Reset',font=('arial',12,'bold'),fg='black',bg='red',bd=3,padx=12,
            command=reset)
